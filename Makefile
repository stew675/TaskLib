...
load_gen:	load_gen.c ticketlock.h task_lib.h task_lib.c ph.h ph.c
		$(CC) -O3 -march=native ph.c task_lib.c load_gen.c -o load_gen -lpthread
...
load_gen-prof:	load_gen.c ticketlock.h task_lib.h task_lib.c ph.h ph.c
		$(CC) -pg -g -march=native -fprofile-arcs -ftest-coverage -o load_gen-prof ph.c picohttpparser.c task_lib.c load_gen.c -lpthread

echoes:		echoes.c ticketlock.h task_lib.h task_lib.c ph.h ph.c
		$(CC) -O3 -march=native ph.c task_lib.c echoes.c -o echoes -lpthread
...
echoes-prof:	echoes.c ticketlock.h task_lib.h task_lib.c ph.h ph.c
		$(CC) -pg -g -march=native -fprofile-arcs -ftest-coverage -o echoes-prof ph.c picohttpparser.c task_lib.c echoes.c -lpthread
